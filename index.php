...
<html lang="en">
  <head>
    <meta charset="UTF-8" />
    <meta author="Brian Isamba">
    <meta description="carnisa is an online car selling platform">
    ...
    <header>
      ...
      <div class="section__container header__container" id="home">
        ...
        <div class="header__content">
          <h1>With Class<br>And Precesion</h1>
          <p>
            Welcome to CarNisa, your ultimate destination for buying cars with ease! We've got you covered.
          </p>
       
        </div>
      </div>
    </header>
    <section class="section__container steps__container" id="inventory">
      <p class="section__subheader">HOW IT WORKS</p>
      <h2 class="section__header">Import a car easily with us</h2>
      <div class="steps__grid">
        <div class="steps__card">
          <span> <a href="location.php">Location</a><i class="ri-map-pin-fill"></i></span>
        ...
        <div class="steps__card">
          <span><a href="date.php">Date</a><i class="ri-calendar-check-fill" ></i></span>
          <h4>Pick-up date</h4>
          <p>
        ...
        <div class="steps__card">
          <span><a href="book.php">Book</a><i class="ri-bookmark-3-fill"></i></span>
          <h4>Book your car</h4>
          <p>
     ...
     <div class="vehicles">
      <a href="gallery.html">Our Vehicles</a>
     </div>
    <section class="section__container service__container" id="service">
      ...
      <div class="service__content">
        ...
        <h2 class="section__header">
          Feel the best experience with our honest Services
        </h2>
    ...
    <section class="section__container download__container" id="contact">
      <div class="download__grid">
        <div class="download__content">
          <h2 class="section__header">Get in touch with us on social media</h2>
          <p>
            Follow us on  all socal media Platforms to find exclusive
            deals, and access 24/7 support, all from the comfort of your zone.
          </p>
          <div class="download__links">
            <a href="#">
              <img src="assets/communication.png" alt="facebook " />
            </a>
            <a href="#">
